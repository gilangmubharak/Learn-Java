...
public class ATMMachine
    {
        ...
        public static void withdrawMoney()
        {
            ...
            else if(TheWithdraw.withdraw > BalanceInquiry.balance)
            {
            ...
            {
                BalanceInquiry.balance = BalanceInquiry.balance - TheWithdraw.withdraw;
                System.out.println("\n\tYou withdraw the amount of Php " + TheWithdraw.withdraw);
            }
        }

        public static void depositMoney()
        {
            System.out.println("\tYou deposited the amount of " + TheDeposit.getDeposit());
        }
                    ...
                    else
                    {
                        switch (select)
                        {
                            case 1:
                                ...
                                TheDeposit.deposit = read.nextDouble();
                                BalanceInquiry.balance = TheDeposit.deposit + BalanceInquiry.balance;
                                depositMoney();
                                break;
                            ...
                            case 2:
                                ...
                                TheWithdraw.withdraw = read.nextDouble();
                                withdrawMoney();
                                break;
